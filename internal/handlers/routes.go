...
func GetRoutes(cfg *config.Config) []router.Route {
	...
	return []router.Route{
		...
		{Name: "auth", Method: "GET", Path: "/auth/authorize", Handler: authHandler},
		{Name: "authPost", Method: "POST", Path: "/auth/authorize", Handler: authPostHandler},
		{Name: "consent", Method: "GET", Path: "/auth/consent", Handler: consentHandler},
		{Name: "consentPost", Method: "POST", Path: "/auth/consent", Handler: consentHandler},
		{Name: "token", Method: "POST", Path: "/auth/token", Handler: tokenHandler},
		{Name: "userinfo", Method: "GET", Path: "/auth/userinfo", Handler: userInfoHandler},
		{Name: "userinfoPost", Method: "POST", Path: "/auth/userinfo", Handler: userInfoHandler},
		{Name: "jwks", Method: "GET", Path: "/auth/jwks", Handler: jwksHandler},
